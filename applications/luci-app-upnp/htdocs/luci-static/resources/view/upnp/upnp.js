...
return view.extend({
	...
	render: function(data) {
		...
		s.taboption('setup', form.Flag, 'enable_pcp_pmp', _('Enable PCP/NAT-PMP protocols')).default = '1';

		s.taboption('setup', form.Flag, 'allow_third_party_maps', _('Allow third-party maps'),
			_('Non-secure mode.'));

		o = s.taboption('setup', form.ListValue, 'upnp_igd_compat', _('UPnP IGD compatiblity mode'));
