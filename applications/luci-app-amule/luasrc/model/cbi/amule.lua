...
s = m:section(TypedSection, "amule")
s.addremove = false
s.anonymous = true
...
o.placeholder = "https://www.amule.org"
...
o = s:taboption("server", Value, "kad_nodes_url", translate("Kad Nodes Url"), "<input type=\"button\" size=\"0\" title=\"" 
    ...
    .. "/>")
o.rmempty = false
o.placeholder = "https://upd.emule-security.org/nodes.dat"
...
o = s:taboption("server", Value, "ed2k_servers_url", translate("Ed2k Servers List Url"), "<input type=\"button\" size=\"0\" title=\"" 
    ...
    .. "/>")
o.rmempty = false
o.placeholder = "https://upd.emule-security.org/server.met"
...
shareddir.titleref = luci.dispatcher.build_url("admin", "system", "mounts")
shareddir.rows = 5
...
o.rmempty = false
o.placeholder = "https://upd.emule-security.org/ipfilter.zip"
