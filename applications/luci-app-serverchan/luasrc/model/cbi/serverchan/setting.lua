...
a:value("/usr/bin/serverchan/api/dingding.json",translate("钉钉"))
a:value("/usr/bin/serverchan/api/feishu.json",translate("飞书"))
a:value("/usr/bin/serverchan/api/bark.json",translate("Bark"))
...
a.rmempty = true
a:depends("jsonpath","/usr/bin/serverchan/api/pushdeer.json")
...
a.rmempty = true
a:depends("jsonpath","/usr/bin/serverchan/api/feishu.json")
...
a.rmempty = true
a:depends("jsonpath","/usr/bin/serverchan/api/bark.json")
...
a=s:taboption("content", ListValue,"serverchan_ipv6",translate("IPv6 变更通知"))
a.rmempty = true
a.default="disable"
...
a=s:taboption("crontab", Value,"google_check_timeout",translate("全球互联检测超时（秒）"))
a.rmempty = true
a.optional = false
a.default = "10"
