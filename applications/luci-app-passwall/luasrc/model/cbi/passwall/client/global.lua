...
trojan_loglevel:value("2", translate("Warning"))
trojan_loglevel:value("3", translate("Error"))
trojan_loglevel:value("4", translate("Critical"))
...
-- [[ Socks Server ]]--
o = s:taboption("Main", Flag, "socks_enabled", "Socks" .. translate("Enable"))
o.rmempty = false
