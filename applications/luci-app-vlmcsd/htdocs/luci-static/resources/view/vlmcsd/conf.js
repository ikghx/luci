...
return view.extend({
	load: function() {
		return L.resolveDefault(fs.read('/etc/vlmcsd/vlmcsd.ini'), '');
	},

	handleSave: function(ev) {
		var value = (document.querySelector('textarea').value || '').trim().replace(/\r\n/g, '\n') + '\n';

		return fs.write('/etc/vlmcsd/vlmcsd.ini', value).then(function(rc) {
	...
	render: function(conf) {
		return E([
			...
			E('p', {}, _('configuration file: /etc/vlmcsd/vlmcsd.ini, Make changes as needed, Take effect immediately after saving.')),
