...
local state=(luci.sys.call("pidof php-fpm > /dev/null") == 0)
...
m = Map("php7-fpm", translate("PHP7") .. state_msg)
...
cf1.write = function(self, section, value)
	...
	luci.util.exec("/etc/init.d/php7-fpm restart >/dev/null 2>&1")
end

local file2 = "/etc/php7-fpm.d/www.conf"
