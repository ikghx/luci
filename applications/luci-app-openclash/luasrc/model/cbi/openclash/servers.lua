...
gs.extedit = DISP.build_url("admin/vpn/openclash/proxy-groups-config/%s").."?file="..file_path
...
ps.extedit = DISP.build_url("admin/vpn/openclash/proxy-providers-config/%s").."?file="..file_path
...
ss.extedit = DISP.build_url("admin/vpn/openclash/proxies-config/%s").."?file="..file_path
