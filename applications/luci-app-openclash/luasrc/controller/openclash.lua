...
function index()
	...
	entry({"admin", "vpn", "openclash", "last_version"},call("action_last_version"))
	...
	entry({"admin", "vpn", "openclash", "proxy-providers-file-manage"},form("openclash/proxy-providers-file-manage"), nil).leaf = true
	...
	entry({"admin", "vpn", "openclash", "proxies-config"},cbi("openclash/proxies-config"), nil).leaf = true
	entry({"admin", "vpn", "openclash", "proxy-groups-config"},cbi("openclash/proxy-groups-config"), nil).leaf = true
	entry({"admin", "vpn", "openclash", "proxy-providers-config"},cbi("openclash/proxy-providers-config"), nil).leaf = true
	...
	entry({"admin", "vpn", "openclash", "save_github_address_mod"}, call("action_save_github_address_mod"))
