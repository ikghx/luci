...
return L.view.extend({
    render: function () {
        var e = new form.Map("v2ray", "%s - %s".format(_("V2Ray"), _("Reverse")), _("Details: %s").format('<a href="https://www.v2ray.com/en/configuration/reverse.html#reverseobject" target="_blank">ReverseObject</a>')),
