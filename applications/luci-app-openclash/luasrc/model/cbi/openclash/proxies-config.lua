...
if not file_path then
	HTTP.redirect(DISP.build_url("admin", "vpn", "openclash", "servers"))
	return
end
...
m.uci = uci
m.pageaction = false
m.redirect = DISP.build_url("admin/vpn/openclash/servers") .. "?file=" .. HTTP.urlencode(file_path)
...
o.rmempty = true
o.placeholder = "mlkem768x25519plus.native/xorpub/random.1rtt/0rtt.(padding len).(padding gap).(X25519 Password).(ML-KEM-768 Client)..."
...
o.rmempty = true
o.placeholder = "CrrQSjAG_YkHLwvM2M-7XkKJilgL5upBKCp0od0tLhE"
o:depends("obfs_vless", "grpc")
o:depends("obfs_vless", "tcp")

o = s:option(Value, "reality_short_id", translate("short-id(reality)"))
o.rmempty = true
o.placeholder = "10f897e26c4b9478"
o:depends("obfs_vless", "grpc")
o:depends("obfs_vless", "tcp")
...
o.rmempty = true
o.placeholder = "User-Agent: okhttp/3.11.0 Dalvik/2.1.0 ...... "
o:depends("type", "http")
...
o.rmempty = true
o.placeholder = "openclash-node"
o:depends("type", "tailscale")

o = s:option(Value, "auth_key", translate("auth-key"))
o.rmempty = true
o.password = true
o.placeholder = "tskey-auth-xxxxxxxxxxxxxxxx"
o:depends("type", "tailscale")
...
o.rmempty = true
o.placeholder = "/etc/openclash/planet"
...
o.rmempty = true
o.placeholder = "/etc/openclash/state"
o:depends("type", "tailscale")
o:depends("type", "zerotier")
