...
return view.extend({
	load: function() {
		return Promise.all([
			L.resolveDefault(callServiceList('swanctl'))
		]);
	},
	render: function(res) {
		...
		m = new form.Map('ipsec', _('strongSwan') + status, _('strongSwan is an OpenSource IPsec implementation.'));

		s = m.section(form.TypedSection, 'remote');
		s.anonymous = true;
