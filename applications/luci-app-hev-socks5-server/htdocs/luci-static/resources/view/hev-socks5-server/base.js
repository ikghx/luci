...
function getServiceStatus() {
	return L.resolveDefault(callServiceList('hev-socks5-server'), {}).then(function (res) {
		var isRunning = false;
		try {
			isRunning = res['hev-socks5-server']['instances']['instance1']['running'];
		} catch (e) {}
		return isRunning;
	});
}
...
return view.extend({
	...
	render: function(data) {
		...
		s = m.section(form.TypedSection, 'hev-socks5-server');
		s.anonymous = true;
