...
return L.view.extend({
    handleServiceReload: function (e) {
        return fs.exec("/etc/init.d/v2ray", ["reload"]).then(L.bind((function (e, o) {
                    0 !== o.code && (ui.addNotification(null, [E("p", _("Reload service failed with code %d").format(o.code)), o.stderr ? E("pre", {}, [o.stderr]) : ""]), L.raise("Error", "Reload failed"))
    ...
    render: function (e) {
        ...
        n = a[1],
        i = void 0 === n ? [] : n,
        l = new form.Map("v2ray", "%s - %s".format(_("V2ray"), _("Global Settings")), "<p>%s</p><p>%s</p>".format(_("A platform for building proxies to bypass network restrictions."), _("For more information, please visit: %s").format('<a href="https://www.v2ray.com" target="_blank">https://www.v2ray.com</a>'))),
        ...
        (o = s.option(form.Value, "v2ray_file", _("executable file"), _("Set the V2Ray or Xray executable file path."))).datatype = "file",
        o.value("/usr/bin/v2ray"),
        o.value("/usr/bin/xray"),
        o.rmempty = !1,
        (o = s.option(form.Value, "asset_location", _("V2Ray asset location"), _("Directory where geoip.dat and geosite.dat files are."))).datatype = "directory",
        o.value("/usr/share/v2ray"),
        (o = s.option(form.Value, "mem_percentage", _("Memory percentage"), _("The maximum percentage of memory used by V2Ray."))).datatype = "and(uinteger, max(100))",
        o.placeholder = "80",
        (o = s.option(form.Value, "config_file", _("Config file"), _("Use custom config file."))).datatype = "file",
        o.value("", _("None")),
