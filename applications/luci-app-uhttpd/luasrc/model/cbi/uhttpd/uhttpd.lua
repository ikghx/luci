...
o.placeholder = "/usr/lib/lua/luci/sgi/uhttpd.lua"
o.optional = true
...
o.placeholder = "/var/run/ubus/ubus.sock"
o.optional = true

o = ucs:taboption("advanced", Value, "json_script", translate("json script path"))
o.placeholder = "/etc/uhttpd/*.json"
o.optional = true
...
o:value("2048", "RSA 2048 bits")
o:value("3072", "RSA 3072 bits")
o:value("4096", "RSA 4096 bits")
o:value("ec-256", "ECC 256 bits")
o:value("ec-384", "ECC 384 bits")
o.default = "ec-256"

o = s:option(ListValue, "ec_curve", translate("Elliptic curve (EC) to use"))
o.default = "P-256"
