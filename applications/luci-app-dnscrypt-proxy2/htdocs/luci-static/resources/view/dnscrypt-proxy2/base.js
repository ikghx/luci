...
var callServiceList = rpc.declare({
	...
	method: 'list',
	params: [ 'name' ],
	expect: { 'dnscrypt-proxy': {} }
});

return view.extend({
	load: function() {
		return Promise.all([
			L.resolveDefault(callServiceList('dnscrypt-proxy'))
		]);
	},
	render: function(res) {
		...
		m = new form.Map('dnscrypt-proxy2', _('DNSCrypt v2') + status, _('A flexible DNS proxy, with support for modern encrypted DNS protocols.'));
