...
function index()
	...
	entry({"admin", "vpn", "openclash", "servers"},cbi("openclash/servers"),_("Servers and Groups"), 50).leaf = true
	...
	entry({"admin", "vpn", "openclash", "config-subscribe"},cbi("openclash/config-subscribe"),_("Config Update"), 70).leaf = true
