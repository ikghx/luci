...
return view.extend({
	...
	render: function (stats) {
		...
		// Basic;
		////////////////
		s = m.section(form.TypedSection, "smartdns");
		s.anonymous = true;
    ...
    o.datatype = 'range(0,3600)';
		...
		// Force AAAA SOA
		o = s.taboption("seconddns", form.Flag, "seconddns_force_aaaa_soa", _("Force AAAA SOA"));
		o.rmempty = true;
		o.default = o.disabled;
		
		// Force HTTPS SOA
		o = s.taboption("seconddns", form.Flag, "seconddns_force_https_soa", _("Force HTTPS SOA"));
		o.rmempty = true;
		o.default = o.disabled;
		...
		o = s.taboption("seconddns", form.Value, "seconddns_ipset_name", _("IPset Name"));
		o.rmempty = true;
		o.datatype = "string";
		o.rempty = true;
		o.validate = function (section_id, value) {
		...
		o = s.taboption("forwarding", form.Flag, "force_aaaa_soa", _("Force AAAA SOA"));
		o.rmempty = true;
		o.default = o.disabled;
		...
		so = ss.option(form.ListValue, "block_domain_type", _("Block domain"));
		so.rmempty = true;
		...
		so = ss.option(form.Flag, "force_aaaa_soa", _("Force AAAA SOA"));
		so.rmempty = true;
