...
function index()
	...
	--[[rule_list]]
	entry({"admin", "vpn", appname, "read_gfwlist"}, call("read_rulelist", "gfw")).leaf = true
	entry({"admin", "vpn", appname, "read_chnlist"}, call("read_rulelist", "chn")).leaf = true
	entry({"admin", "vpn", appname, "read_chnroute"}, call("read_rulelist", "chnroute")).leaf = true
