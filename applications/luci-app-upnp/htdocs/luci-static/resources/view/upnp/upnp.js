...
return view.extend({
	...
	render: function(data) {
		...
		s.taboption('general', form.Flag, 'ext_ip_reserved_ignore', _('Ignore reserved ext_ip'),
		...
		o = s.taboption('advanced', form.Value, 'notify_interval', _('Notify interval (second)'))
		o.datatype    = 'uinteger'
		o.placeholder = 30
