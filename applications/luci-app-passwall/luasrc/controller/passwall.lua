...
function index()
	...
	entry({"admin", "vpn", appname, "log"}, form(appname .. "/client/log"), _("Runtime Logs"), 999).leaf = true
	...
	--[[ API ]]
	entry({"admin", "vpn", appname, "server_user_update"}, call("server_user_update")).leaf = true
