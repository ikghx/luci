...
var gfwlistUrls = {
    github: "https://fastly.jsdelivr.net/gh/YW5vbnltb3Vz/domain-list-community@release/gfwlist.txt",
...
return L.view.extend({
    handleListUpdate: function (t, e, r) {
        ...
        a = function (t, e, r) {
            L.Request.request(L.url("admin/vpn/v2ray/request"), {
                method: "post",
                timeout: 6e4,
                query: {
                    url: t,
                    ...
                    if (200 === t.status && (a = t.json())) {
                        ...
                        if (!a.code && (o = a.content)) {
                            ...
                            L.raise("Error", a.message || _("Failed to fetch data."))
                    } else
                        L.raise("Error", t.statusText)
                })).catch((function (t) {
    ...
    render: function (t) {
        ...
        return e.datatype = "port",
        (e = i.option(widgets.NetworkSelect, "lan_ifaces", _("LAN interfaces"), _("Enable proxy on selected interfaces."))).multiple = !0,
        e.nocreate = !0,
        ...
        (e = i.option(form.ListValue, "proxy_mode", _("Proxy mode"), _("If enabled, iptables rules will be added to pre-filter traffic and then sent to V2Ray."))).value("default", _("Default")),
        ...
        (e = i.option(custom.TextValue, "_direct_list", _("Extra direct list"), _("One address per line. Allow types: DOMAIN, IP, CIDR. eg: %s, %s, %s").format("www.google.com", "1.1.1.1", "192.168.0.0/16"))).wrap = "off",
        e.rows = 5,
        e.datatype = "string",
        e.filepath = "/etc/v2ray/directlist.txt",
        e = i.option(form.Value, "proxy_list_dns", _("Proxy list DNS"), _("DNS used for domains in proxy list, format: <code>ip#port</code>. eg: %s").format("1.1.1.1#53")),
