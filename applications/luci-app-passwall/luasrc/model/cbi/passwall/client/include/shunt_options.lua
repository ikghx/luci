...
o = add_option(Flag, "preproxy_enabled", translate("Preproxy") .. " " .. translate("Enable"))
...
o = add_option(Flag, "fakedns", '<a style="color:#FF8C00">FakeDNS</a>' .. " " .. translate("Enable"), translate("Use FakeDNS work in the domain that proxy.") .. "<br>" ..
