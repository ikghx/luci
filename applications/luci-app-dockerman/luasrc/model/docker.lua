...
_docker.new = function()
	...
	if uci:get_bool("dockerd", "globals", "remote_endpoint") then
	...
	local status_path = uci:get("dockerd", "globals", "status_path") or "/tmp/.docker_action_status"
...
_docker.options.status_path = uci:get("dockerd", "globals", "status_path") or "/tmp/.docker_action_status"
