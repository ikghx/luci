...
o:value("https://cdn.jsdelivr.net/gh/neodevpro/neodevhost@master/lite_host_dnsmasq.conf", translate("NEO DEV HOST Lite"))
o:value("https://cdn.jsdelivr.net/gh/neodevpro/neodevhost@master/host_dnsmasq.conf", translate("NEO DEV HOST Full"))
o:value("https://cdn.jsdelivr.net/gh/privacy-protection-tools/anti-AD@master/adblock-for-dnsmasq.conf", translate("anti-AD"))
o.default = "https://cdn.jsdelivr.net/gh/neodevpro/neodevhost@master/lite_host_dnsmasq.conf"
o:depends("adblock", "1")
...
o:value("https://cdn.jsdelivr.net/gh/QiuSimons/Netflix_IP@master/NF_only.txt", translate("Netflix IP Only"))
o:value("https://cdn.jsdelivr.net/gh/QiuSimons/Netflix_IP@master/getflix.txt", translate("Netflix and AWS"))
o.default = "https://cdn.jsdelivr.net/gh/QiuSimons/Netflix_IP@master/NF_only.txt"
