...
function getServiceStatus() {
	return L.resolveDefault(callServiceList('frpc'), {})
		.then(function (res) {
			var isRunning = false;
			try {
...
return view.extend({
	...
	render: function(res) {
		...
		m = new form.Map('frpc', _('frp client'), _('frp is a fast reverse proxy to help you expose a local server behind a NAT or firewall to the Internet.'));
