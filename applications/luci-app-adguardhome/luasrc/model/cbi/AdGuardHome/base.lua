...
---- Redirect
o = s:option(ListValue, "redirect", translate("Listening port redirection"), translate("AdGuardHome redirect mode"))
...
o.optional = true
---- bin path
o = s:option(Value, "binpath", translate("Bin Path"), translate("AdGuardHome Bin path"))
