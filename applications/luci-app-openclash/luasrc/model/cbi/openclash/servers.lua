...
gs.extedit = DISP.build_url("admin/vpn/openclash/groups-config/%s").."?file="..file_path
...
ps.extedit = DISP.build_url("admin/vpn/openclash/proxy-provider-config/%s").."?file="..file_path
...
ss.extedit = DISP.build_url("admin/vpn/openclash/servers-config/%s").."?file="..file_path
