...
function index()
	...
	entry({"admin", "vpn", "openclash"}, firstchild(), _("OpenClash"), 50).acl_depends = { "luci-app-openclash" }
	entry({"admin", "vpn", "openclash", "client"},form("openclash/client"),_("Overviews"), 20).leaf = true
	entry({"admin", "vpn", "openclash", "conn_status"},call("action_conn_status")).leaf=true
	...
	entry({"admin", "vpn", "openclash", "get_last_version"},call("action_get_last_version"))
	...
	entry({"admin", "vpn", "openclash", "flush_smart_cache"}, call("action_flush_smart_cache"))
	...
	entry({"admin", "vpn", "openclash", "backup_ex_core"}, call("action_backup_ex_core"))
	entry({"admin", "vpn", "openclash", "backup_only_core"}, call("action_backup_only_core"))
	entry({"admin", "vpn", "openclash", "backup_only_config"}, call("action_backup_only_config"))
	entry({"admin", "vpn", "openclash", "backup_only_rule"}, call("action_backup_only_rule"))
	entry({"admin", "vpn", "openclash", "backup_only_proxy"}, call("action_backup_only_proxy"))
	...
	entry({"admin", "vpn", "openclash", "dashboard_type"}, call("action_dashboard_type"))
	entry({"admin", "vpn", "openclash", "switch_dashboard"}, call("action_switch_dashboard"))
	entry({"admin", "vpn", "openclash", "delete_dashboard"}, call("action_delete_dashboard"))
	entry({"admin", "vpn", "openclash", "default_dashboard"}, call("action_default_dashboard"))
	entry({"admin", "vpn", "openclash", "get_run_mode"}, call("action_get_run_mode"))
	entry({"admin", "vpn", "openclash", "create_file"}, call("create_file"))
	entry({"admin", "vpn", "openclash", "rename_file"}, call("rename_file"))
	...
	entry({"admin", "vpn", "openclash", "config-subscribe"},cbi("openclash/config-subscribe"),_("Config Subscribe"), 60).leaf = true
	entry({"admin", "vpn", "openclash", "servers"},cbi("openclash/servers"),nil).leaf = true
	entry({"admin", "vpn", "openclash", "other-rules-edit"},cbi("openclash/other-rules-edit"), nil).leaf = true
	entry({"admin", "vpn", "openclash", "custom-dns-edit"},cbi("openclash/custom-dns-edit"), nil).leaf = true
	...
	entry({"admin", "vpn", "openclash", "config"},form("openclash/config"),_("Config Manage"), 80).leaf = true
	entry({"admin", "vpn", "openclash", "log"},cbi("openclash/log"),_("Server Logs"), 90).leaf = true
	entry({"admin", "vpn", "openclash", "myip_check"}, call("action_myip_check"))
	entry({"admin", "vpn", "openclash", "website_check"}, call("action_website_check"))
	entry({"admin", "vpn", "openclash", "version_history"}, call("action_version_history"))
	entry({"admin", "vpn", "openclash", "cdn_info"}, call("action_cdn_info"))
	entry({"admin", "vpn", "openclash", "proxy_info"}, call("action_proxy_info"))
	entry({"admin", "vpn", "openclash", "oc_settings"}, call("action_oc_settings"))
	entry({"admin", "vpn", "openclash", "switch_oc_setting"}, call("action_switch_oc_setting"))
	entry({"admin", "vpn", "openclash", "generate_pac"}, call("action_generate_pac"))
	entry({"admin", "vpn", "openclash", "action"}, call("action_oc_action"))
	entry({"admin", "vpn", "openclash", "config_file_list"}, call("action_config_file_list"))
	entry({"admin", "vpn", "openclash", "config_file_read"}, call("action_config_file_read"))
	entry({"admin", "vpn", "openclash", "config_file_save"}, call("action_config_file_save"))
	entry({"admin", "vpn", "openclash", "upload_config"}, call("action_upload_config"))
	entry({"admin", "vpn", "openclash", "add_subscription"}, call("action_add_subscription"))
	entry({"admin", "vpn", "openclash", "subconverter_version"}, call("action_subconverter_version"))
	entry({"admin", "vpn", "openclash", "generate_age_key"}, call("action_generate_age_key"))
	entry({"admin", "vpn", "openclash", "cal_age_public_key"}, call("action_cal_age_public_key"))
	entry({"admin", "vpn", "openclash", "add_age_config"}, call("action_add_age_config"))
	entry({"admin", "vpn", "openclash", "upload_overwrite"}, call("action_upload_overwrite"))
	entry({"admin", "vpn", "openclash", "overwrite_subscribe_info"}, call("action_overwrite_subscribe_info"))
	entry({"admin", "vpn", "openclash", "overwrite_file_list"}, call("action_overwrite_file_list"))
	entry({"admin", "vpn", "openclash", "delete_overwrite_file"}, call("delete_overwrite_file"))
	entry({"admin", "vpn", "openclash", "get_subscribe_data"}, call("action_get_subscribe_data"))
	entry({"admin", "vpn", "openclash", "get_subscribe_info_data"}, call("action_get_subscribe_info_data"))
	entry({"admin", "vpn", "openclash", "oix_info"}, call("oix_info"))
	entry({"admin", "vpn", "openclash", "oix_checkin"}, call("oix_checkin"))
	entry({"admin", "vpn", "openclash", "oix_logout"}, call("oix_logout"))
	entry({"admin", "vpn", "openclash", "oix_login"}, call("oix_login"))
	entry({"admin", "vpn", "openclash", "oix_login_info_save"}, call("oix_login_info_save"))
	entry({"admin", "vpn", "openclash", "oix_params_sync"}, call("oix_params_sync"))
	entry({"admin", "vpn", "openclash", "oix_params_get"}, call("oix_params_get"))
end
...
local function check_lastversion()
	SYS.exec("bash /usr/share/openclash/openclash_version.sh 2>/dev/null")
...
local function corelv()
	...
	if fs.access("/tmp/clash_last_version") then
		if core_type == "Oix" or oix_token ~= "" then
			core_meta_lv = SYS.exec("sed -n 1p /tmp/clash_last_version 2>/dev/null |tr -d '\n'")
		elseif core_smart_enable == "1" then
			core_meta_lv = SYS.exec("sed -n 2p /tmp/clash_last_version 2>/dev/null |tr -d '\n'")
		else
			core_meta_lv = SYS.exec("sed -n 1p /tmp/clash_last_version 2>/dev/null |tr -d '\n'")
		end
	else
...
local function oplv()
	...
	if fs.access("/tmp/openclash_last_version") then
		oplv = SYS.exec("sed -n 1p /tmp/openclash_last_version 2>/dev/null |tr -d '\n'")
	else
		oplv = "loading..."
	end
...
function action_get_last_version()
	if not process_status("/usr/share/openclash/clash_version.sh") then
		if tonumber(os.time() - (fs.mtime("/tmp/clash_last_version") or 0)) > 1800 then
			SYS.call("bash /usr/share/openclash/clash_version.sh &")
		end
	end
	if not process_status("/usr/share/openclash/openclash_version.sh") then
		if tonumber(os.time() - (fs.mtime("/tmp/openclash_last_version") or 0)) > 1800 then
			SYS.call("bash /usr/share/openclash/openclash_version.sh &")
		end
	end
end
...
function action_version_history()
	...
	local result = { plugin = {}, core_meta = {}, core_smart = {}, error = nil }
	local skip_core = is_oix()

	-- Read TTL, invalidate if settings changed
	local cache_file = "/tmp/openclash_version_history_" .. branch .. ".json"
	...
	if plugin_raw and plugin_raw ~= "" and plugin_raw:match('"sha"') then
		...
		if ok and type(plugin_commits) == "table" then
			for _, c in ipairs(plugin_commits) do
				if c.sha and c.commit and c.commit.message then
					local ver = c.commit.message:match("v([%d%.]+%-?%w*)")
					local date = c.commit.committer and c.commit.committer.date or ""
					table.insert(result.plugin, {
						version = ver and ("v" .. ver) or nil,
						date = date,
						sha = c.sha,
		...
		if core_raw and core_raw ~= "" and core_raw:match('"sha"') then
			...
			if ok and type(core_commits) == "table" then
				for _, c in ipairs(core_commits) do
					if c.sha and c.commit and c.commit.message then
						local meta_ver = c.commit.message:match("Meta to (alpha%-g%w+)")
						local smart_ver = c.commit.message:match("Smart to (alpha%-smart%-g%w+)")
						local date = c.commit.committer and c.commit.committer.date or ""
						if meta_ver then
							table.insert(result.core_meta, { version = meta_ver, date = date, sha = c.sha })
						end
						if smart_ver then
							table.insert(result.core_smart, { version = smart_ver, date = date, sha = c.sha })
						end
					end
				end
			end
...
# Fetch plugin version + measure latency
...
# Fetch core version + measure latency (skip if Oix: pre-fetched or in Oix mode)
if [ -z "$CORE_META_VER" ] && [ "$OIX_MODE" != "1" ]; then
