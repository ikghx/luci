...
function getServiceStatus() {
	return L.resolveDefault(callServiceList('hev-socks5-tproxy'), {}).then(function (res) {
		var isRunning = false;
		try {
			isRunning = res['hev-socks5-tproxy']['instances']['instance1']['running'];
		} catch (e) {}
		return isRunning;
	});
}
...
return view.extend({
	...
	render: function(data) {
		...
		s = m.section(form.TypedSection, 'hev-socks5-tproxy');
		s.anonymous = true;
