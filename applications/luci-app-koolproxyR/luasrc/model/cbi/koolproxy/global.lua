...
if sys.call("pidof koolproxy >/dev/null") == 0 then
	status = translate("<strong class=\"koolproxy_status\"><font color=\"green\">KoolProxyR Plus+  运行中</font></strong>")
else
	status = translate("<strong class=\"koolproxy_status\"><font color=\"red\">KoolProxyR Plus+  未运行</font></strong>")
end
